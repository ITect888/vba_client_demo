 ...
 *
 */
public class Function2001209Test {
	
	private static Log log = LogFactory.getLog(Function2001209Test.class);
	
	static final String FUNC_NO="2001209";
	 ...
	 * 证件类型
	 * 
	 * 001-身份证		414：定居国外的中国公民护照，普通护照	516：港澳居民来往内地通行证		553：外国人永久居留身份证
	 * 
	 * 参与签名
	 */
	String idtype="";
	 ...
	 * 国籍3个字简写码
	 * 
	 * 	长度3位	除港澳以外请见 “国际简码”	定居国外的中国公民和港澳居民使用CHN
	 * 
	 * 参与签名
	 */
	String nation="";
	...
	private void processResult(String result) {
		 Json1209 json=JSON.parseObject(result,Json1209.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result1209 re=json.getResults().get(0);
