 ...
 *
 */
public class Function2001239Test {
	
	private static Log log = LogFactory.getLog(Function2001239Test.class);
	
	static final String FUNC_NO="2001239";
