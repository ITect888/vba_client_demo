 ...
 * 一键登录获取手机号服务 配合SDK使用
 */
public class Function2001276Test {
	
	private static Log log = LogFactory.getLog(Function2001276Test.class);
	
	static final String FUNC_NO="2001276";
	 ...
	 * appid SDK授权码 接入时下发
	 */
	String appId ="300012055217";

	/**
	 * SDK授权密钥  接入时下发
	 */
	String appKey="5FE342EC01A5346FA002F7F8B9717FD1";
	...
	private Map<String, String> buildParams() {
		...
		params.put(FunctionCommon.TO_SIGN_HEAD+"appKey",appKey);
