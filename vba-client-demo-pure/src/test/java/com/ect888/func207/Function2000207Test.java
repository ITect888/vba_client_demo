 ...
 *
 */
public class Function2000207Test {
	
	private static Log log = LogFactory.getLog(Function2000207Test.class);
	
	static final String FUNC_NO="2000207";
	...
	private void processResult(String result) {
		 Json207 json=JSON.parseObject(result,Json207.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result207 re=json.getResults().get(0);
