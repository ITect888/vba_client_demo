 ...
 *
 */
public class Function2000209CopyTest {
	
	private static Log log = LogFactory.getLog(Function2000209CopyTest.class);
	
	static final String FUNC_NO="2000209";
	...
	private void processResult(String result) {
		 Json209Copy json=JSON.parseObject(result,Json209Copy.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result209Copy re=json.getResults().get(0);
