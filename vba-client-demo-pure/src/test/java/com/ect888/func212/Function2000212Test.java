 ...
 * @author fanyj
 */
public class Function2000212Test {
	
	private static Log log = LogFactory.getLog(Function2000212Test.class);
	
	static final String FUNC_NO="2000212";
	 ...
	 * 必填
	 */
	String certseq="422823199107192312";
	...
	private void processResult(String result) {
		 Json212 json=JSON.parseObject(result,Json212.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result212 re=json.getResults().get(0);
			 log.info("业务应答码respcd="+re.getRespcd());
			 log.info("业务应答信息respinfo="+re.getRespinfo());
			 if("8000".equals(re.getRespcd())) {
				 log.info("不良状态iscriminal="+re.getIscriminal());
			 }
