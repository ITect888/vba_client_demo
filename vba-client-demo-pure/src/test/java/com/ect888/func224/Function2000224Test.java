 ...
 *
 */
public class Function2000224Test {
	
	private static Log log = LogFactory.getLog(Function2000224Test.class);
	
	static final String FUNC_NO="2000224";
	 ...
	 * 必填
	 */
	String certseq="370902199806220917";
	 ...
	 * 
	 * 调用2000224实名认证接口：上送参数（biztyp,biztypdesc,certseq,placeid,ptyacct,ptycd,sourcechnl,timestamp, videopic, usernm,funcNo,sign(签名)）
	...
	private Map<String, String> buildParams() {
		...
		params.put(FunctionCommon.TO_AES_TO_URL_TO_BASE64_HEAD+"archiveno", archiveno);
	...
	private void processResult(String result) {
		 Json224 json=JSON.parseObject(result,Json224.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result224 re=json.getResults().get(0);
