 ...
 * 在网时长
 */
public class Function2000229Test {
	
	private static Log log = LogFactory.getLog(Function2000229Test.class);
	
	static final String FUNC_NO="2000229";
	...
	/**
	 *
	 上送参数(biztyp,biztypdesc,certseq,phoneno,placeid,ptyacct,ptycd,sourcechnl,timestamp,key(会话密钥)），
	 其中key前面的是按照字母排序的，key则是要最后附加上去。
	 其中在签名的时候身份证号需要利用会话密钥进行AES加密。签名过程生成签名密钥sign
	...
	public void doWork(){
		...
		//解析返回数据并处理
		Function2000102Test function2000102Test  =  new Function2000102Test();
		function2000102Test.doWork(result);
	}
