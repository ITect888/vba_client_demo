 ...
 *
 */
public class Function2000230Test {
	
	private static Log log = LogFactory.getLog(Function2000230Test.class);
	
	static final String FUNC_NO="2000230";
	...
	private void processResult(String result) {
		 Json230 json=JSON.parseObject(result,Json230.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result230 re=json.getResults().get(0);
