 ...
 *
 */
public class Function2000237Test {
	
	private static Log log = LogFactory.getLog(Function2000237Test.class);
	
	static final String FUNC_NO="2000237";
	...
	private void processResult(String result) {
		 Json237 json=JSON.parseObject(result,Json237.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result237 re=json.getResults().get(0);
