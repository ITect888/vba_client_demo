 ...
 *
 */
public class Json241 extends JsonCommon{

	private ArrayList<Result241> results;

	public ArrayList<Result241> getResults() {
		return results;
	}

	public void setResults(ArrayList<Result241> results) {
