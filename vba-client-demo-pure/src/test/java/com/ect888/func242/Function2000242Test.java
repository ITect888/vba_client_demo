 ...
 *
 */
public class Function2000242Test {
	
	static final String FUNC_NO="2000242";
	 ...
	 * [c],base64（[b]中字符串） 
	 */
	String addr="a_家庭_f_12_i_11_l_true_v_高";
	/**
	 * 地址类型
	 * 0：中文地址
	 * 1：地址坐标（WGS84标准）
	...
	private void processResult(String result) {
		 Json242 json=JSON.parseObject(result,Json242.class);
	...
	private static Log log = LogFactory.getLog(Function2000242Test.class);
