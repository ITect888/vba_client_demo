 ...
 *
 */
public class Function2000243Test {
	
	static final String FUNC_NO="2000243";
	 ...
	 */
	String frontBase=Thread.currentThread().getContextClassLoader().getResource("").getPath()+File.separator+"fanyj_card.jpg";
	...
	private Map<String, String> buildParams() {
		...
		params.put(FunctionCommon.TO_PIC_BASE64_HEAD+"bussicardfront", frontBase);
	...
	private void processResult(String result) {
		 Json243 json=JSON.parseObject(result,Json243.class);
	...
	private static Log log = LogFactory.getLog(Function2000243Test.class);
