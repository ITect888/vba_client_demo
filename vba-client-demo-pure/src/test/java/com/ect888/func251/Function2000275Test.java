 ...
 *
 */
public class Function2000275Test {
	
	private static Log log = LogFactory.getLog(Function2000275Test.class);
	
	static final String FUNC_NO="2000275";
	...
	private Map<String, String> buildParams() {
		...
		params.put(FunctionCommon.TO_PIC_BASE64_HEAD+"facePic", videopic);
		...
		params.put(FunctionCommon.TO_SIGN_HEAD+"sdkversion",config.getPtycd());
		params.put(FunctionCommon.TO_SIGN_HEAD+"facepicres",config.getPtycd());
	...
	private void processResult(String result) {
		 Json251 json=JSON.parseObject(result,Json251.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result251 re=json.getResults().get(0);
