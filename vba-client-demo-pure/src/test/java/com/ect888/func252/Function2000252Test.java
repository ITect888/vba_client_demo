 ...
 *
 */
public class Function2000252Test {
	
	private static Log log = LogFactory.getLog(Function2000252Test.class);
	
	static final String FUNC_NO="2000252";
	 ...
	 * 
	 * 调用2000252比对查询接口：上送参数（biztyp,biztypdesc,certseq,placeid,ptyacct,ptycd,sourcechnl,timestamp, videopic, usernm,funcNo,sign(签名)）
	...
	private void processResult(String result) {
		 Json252 json=JSON.parseObject(result,Json252.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result252 re=json.getResults().get(0);
