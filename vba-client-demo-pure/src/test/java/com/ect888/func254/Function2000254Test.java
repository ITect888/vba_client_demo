...
import com.ect888.func254.Json254;
import com.ect888.func254.Result254;
...
public class Function2000254Test {
	 ...
	 * 
	 * 调用2000254比对查询接口：上送参数（biztyp,biztypdesc,certseq,placeid,ptyacct,ptycd,sourcechnl,timestamp, videopic, usernm,funcNo,sign(签名)）
