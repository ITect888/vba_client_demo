...
/**
 * 2000259证通手机二要素（姓名+手机号）认证服务
 * 示例代码
 * 
 * @author fanyj
 *
 */
public class Function2000259Test {
	
	static final String FUNC_NO="2000259";
	...
	private void processResult(String result) {
		 Json259 json=JSON.parseObject(result,Json259.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result259 re=json.getResults().get(0);
	...
	private static Log log = LogFactory.getLog(Function2000259Test.class);
