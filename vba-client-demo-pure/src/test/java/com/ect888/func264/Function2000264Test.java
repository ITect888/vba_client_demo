 ...
 *
 */
public class Function2000264Test {
	
	private static Log log = LogFactory.getLog(Function2000264Test.class);
	
	static final String FUNC_NO="2000264";
	 ...
	 * 必填
	 */
	String certseq="610302199101185125";
	 ...
	 * 
	 * 调用2000264比对查询接口：上送参数（biztyp,biztypdesc,certseq,placeid,ptyacct,ptycd,sourcechnl,timestamp, videopic, usernm,funcNo,sign(签名)）
	...
	private void processResult(String result) {
		 Json264 json=JSON.parseObject(result,Json264.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result264 re=json.getResults().get(0);
