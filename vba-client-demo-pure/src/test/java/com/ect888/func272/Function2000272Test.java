...
public class Function2000272Test {
	 ...
	 * 不支持1MB以上的图片。
	 */
	String ocrPic=Thread.currentThread().getContextClassLoader().getResource("").getPath()+File.separator+"123.jpg";
	...
	private Map<String, String> buildParams() {
		...
		params.put(FunctionCommon.TO_PIC_BASE64_HEAD+"facePic", ocrPic);
