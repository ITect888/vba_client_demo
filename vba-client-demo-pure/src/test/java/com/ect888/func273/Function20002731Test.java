...
public class Function20002731Test {
	...
	private static Log log = LogFactory.getLog(Function20002731Test.class);
	...
	private Map<String, String> buildParams() {
		...
		params.put(FunctionCommon.TO_SIGN_HEAD+"label","3696");
		params.put(FunctionCommon.TO_SIGN_HEAD+"type","mp4");
		params.put(FunctionCommon.TO_SIGN_HEAD+"token","1900917759");
