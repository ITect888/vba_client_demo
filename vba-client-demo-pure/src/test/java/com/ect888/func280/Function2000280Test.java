 ...
 * NFC云识读服务
 */
public class Function2000280Test {
	
	private static Log log = LogFactory.getLog(Function2000280Test.class);
	
	static final String FUNC_NO="2000280";
	...
	private Map<String, String> buildParams() {
		...
		params.put(FunctionCommon.TO_SIGN_HEAD+"reqId",reqId);
