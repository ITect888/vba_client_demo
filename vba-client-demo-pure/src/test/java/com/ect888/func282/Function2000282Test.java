 ...
 */
public class Function2000282Test {
	
	private static Log log = LogFactory.getLog(Function2000282Test.class);
	
	static final String FUNC_NO="2000282";
