 ...
 *
 */
public class Function2000291Test {
	
	private static Log log = LogFactory.getLog(Function2000291Test.class);
	
	static final String FUNC_NO="2000291";
	...
	private Map<String, String> buildParams() {
		...
		params.put(FunctionCommon.TO_SIGN_HEAD+"regtime", regtime);
