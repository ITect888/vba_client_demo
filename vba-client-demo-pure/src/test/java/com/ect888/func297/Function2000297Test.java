 ...
 * 电信三要素MD5认证
 */
public class Function2000297Test {

    private static Log log = LogFactory.getLog(Function2000297Test.class);

    static final String FUNC_NO = "2000297";
