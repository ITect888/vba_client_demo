 ...
 *
 */
public class Function2000300Test {
	
	private static Log log = LogFactory.getLog(Function2000300Test.class);
	
	static final String FUNC_NO="2000300";
	...
	private void processResult(String result) {
		 Json300 json=JSON.parseObject(result, Json300.class);
		 ...
		 if("0".equals(json.getError_no())) {//系统级调用成功
			 ...
			 Result300 re=json.getResults().get(0);
