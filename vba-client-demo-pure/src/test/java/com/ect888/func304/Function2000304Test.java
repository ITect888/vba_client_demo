 ...
 * 返回
 */
public class Function2000304Test {
	
	private static Log log = LogFactory.getLog(Function2000304Test.class);
	
	static final String FUNC_NO="2000304";
