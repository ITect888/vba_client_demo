 ...
 * 移动SHA310
 */
public class Function2000310Test {

    private static Log log = LogFactory.getLog(Function2000310Test.class);

    static final String FUNC_NO = "2000310";
