 ...
 * 电信SHA311
 */
public class Function2000311Test {

    private static Log log = LogFactory.getLog(Function2000311Test.class);

    static final String FUNC_NO = "2000311";
