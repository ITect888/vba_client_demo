...
public class Function2000315Test {

    private static Log log = LogFactory.getLog(Function2000315Test.class);

    static final String FUNC_NO = "2000315";
