 ...
 * 在网状态查询 MD5 移动
 */
public class Function2000322Test {

    private static Log log = LogFactory.getLog(Function2000322Test.class);

    static final String FUNC_NO = "2000322";
