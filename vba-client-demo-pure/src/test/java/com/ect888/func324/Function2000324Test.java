 ...
 * 在网状态查询 MD5 电信
 */
public class Function2000324Test {

    private static Log log = LogFactory.getLog(Function2000324Test.class);

    static final String FUNC_NO = "2000324";
