 ...
 * 在网状态查询 SHA256 移动
 */
public class Function2000325Test {

    private static Log log = LogFactory.getLog(Function2000325Test.class);

    static final String FUNC_NO = "2000325";
