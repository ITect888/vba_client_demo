 ...
 * 移在网状态查询 SHA256 联通
 */
public class Function2000326Test {

    private static Log log = LogFactory.getLog(Function2000326Test.class);

    static final String FUNC_NO = "2000326";
