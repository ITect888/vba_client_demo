...
public class Function2000337Test {
	
	static final String FUNC_NO="2000337";
	 ...
	 *
	 */
	String usernm=SHA256.getSha256("姓名".getBytes(StandardCharsets.UTF_8));;
	...
	private static Log log = LogFactory.getLog(Function2000337Test.class);
