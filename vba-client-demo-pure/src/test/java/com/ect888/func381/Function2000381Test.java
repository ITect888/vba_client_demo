 ...
 * 
 */
public class Function2000381Test {
	
	private static Log log = LogFactory.getLog(Function2000381Test.class);
	
	static final String FUNC_NO="2000381";
	 ...
	 */
	String photoData=Thread.currentThread().getContextClassLoader().getResource("").getPath()+File.separator+"2.jpg";
